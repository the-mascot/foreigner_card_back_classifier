...
echo "=== 설정 완료 ==="
echo "다음 단계:"
echo "1. data/train/ 및 data/validation/ 폴더에 이미지 추가"
echo "2. 모델 훈련: python src/train_model.py"
...
echo ""
echo "Jupyter 노트북 실행: jupyter notebook notebooks/training_notebook.ipynb"
